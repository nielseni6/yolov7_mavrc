...
if __name__ == '__main__':
    ...
    parser.add_argument('--nsteps', type=int, default=13, help='number of steps to assess SNR at [step size is (nsteps-1) / (snr_end - snr_begin)]') 
    ...
    # opt.attack_weights = 'weights/pgt_runs_best/dist_reg_only(pgt5_1228).pt'
    # opt.attack_weights = 'weights/pgt_runs_best/dist_reg_only(pgt5_1222).pt'
    
    opt.black_box = False if opt.attack_weights is None else True
    ...
    opt.weights_dir = 'weights/pgt_runs7' 
