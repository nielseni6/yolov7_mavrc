...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float, default=17.0, help='alpha')
    ...
    parser.add_argument('--scheduler', type=float, default=3.0, help='scheduler for alpha')
    ...
    attr = (gaussian_blur((torch.rand(len(unique_classes), 1, 640, 640)**4), 9)**4).requires_grad_(True)
