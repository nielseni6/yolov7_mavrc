...
if __name__ == '__main__':
    ...
    parser.add_argument('--iou_coeff', type=float, default=1.0, help='iou_coeff')
    ...
    attr = (gaussian_blur(torch.rand(len(unique_classes), 1, 480, 480)**2, 3)**4).requires_grad_(True)
